        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                ...
                <asp:RequiredFieldValidator runat="server" ControlToValidate="UserName"
                    CssClass="text-danger" ErrorMessage="Απαιτείται όνομα" />
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-10">
                ...
                <asp:RequiredFieldValidator runat="server" ControlToValidate="Password"
                    CssClass="text-danger" ErrorMessage="Απαιτείται κωδικός" />
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-10">
                ...
                <asp:RequiredFieldValidator runat="server" ControlToValidate="ConfirmPassword"
                    CssClass="text-danger" Display="Dynamic" ErrorMessage="Απαιτείται επιβεβαίωση κωδικού" />
                <asp:CompareValidator runat="server" ControlToCompare="Password" ControlToValidate="ConfirmPassword"
                    CssClass="text-danger" Display="Dynamic" ErrorMessage="Οι κωδικοί δεν ταιριάζουν" />
            </div>
        </div>
        <div class="form-group">
